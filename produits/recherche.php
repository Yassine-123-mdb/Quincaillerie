  ...
  <div class="produits-populaires">
    <div class="product-list">
        <div class="product-card horizontal-card">
          <img class="card-img" src="../image/<?php echo $res['img']; ?>" alt="Card image cap">
          <div class="card-content">
            <h5 class="card-title"><?php echo $res['nom']; ?></h5>
            <h5 class="card-title">Prix:<?php echo $res['prix']; ?></h5>
            <p class="card-text"><?php echo $res['decs']; ?> </p>
